        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneBatteryBatteryID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Phones", x => x.PhoneId);
                    table.ForeignKey(
                        name: "FK_Phones_Batteries_PhoneBatteryBatteryID",
                        column: x => x.PhoneBatteryBatteryID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPhones", x => new { x.OrderId, x.PhoneId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPhones_Phones_PhoneId",
                        column: x => x.PhoneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Phones_PhoneBatteryBatteryID",
                table: "Phones",
                column: "PhoneBatteryBatteryID");
        }
